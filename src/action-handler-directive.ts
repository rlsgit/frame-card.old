...
customElements.define('action-handler-framecard', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-framecard')) {
    return body.querySelector('action-handler-framecard') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-framecard');
